...
const totalMoneyPledged = GAMES_JSON.reduce((acc, game) => acc + game.pledged, 0);
...
const unfundedExplanation = `
    A total of \$${totalMoneyPledged.toLocaleString("en-US")} has been raised for 
    ${GAMES_JSON.length} games. Currently, ${numberOfUnfundedGames} 
    ${numberOfUnfundedGames > 1 ? "games remain" : "games remain"} unfunded. 
    We need your help to fund these amazing games!
`;

// create a new DOM element containing the template string and append it to the description container
const explanationParagraph = document.createElement("p");
explanationParagraph.innerHTML = unfundedExplanation;
descriptionContainer.append(explanationParagraph);
...
const firstPlacePara = document.createElement("p");
firstPlacePara.innerHTML = `${first.name}`;
document.querySelector("#first-game").append(firstPlacePara);
